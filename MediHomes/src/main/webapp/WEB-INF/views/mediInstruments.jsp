        ...
        <div id="scroll" class="scroll">
			...
			<div class="pageNum">
				<c:if test="${ startPage > pageGroup }">
					<a href="mediInstruments?pageNum=${ startPage - pageGroup }&keyword=${ keyword }">←</a>
				</c:if>
				<c:forEach var="i" begin="${ startPage }" end="${ endPage }">
					...
					<c:if test="${ i != currentPage }">
						<a href="mediInstruments?pageNum=${ i }&keyword=${ keyword }">${ i }</a>
					</c:if>
				</c:forEach>
	
				<c:if test="${ endPage < pageCount }">
					<a href="mediInstruments?pageNum=${ startPage + pageGroup }
					&keyword=${ keyword }">→</a>
				</c:if>
			</div>
